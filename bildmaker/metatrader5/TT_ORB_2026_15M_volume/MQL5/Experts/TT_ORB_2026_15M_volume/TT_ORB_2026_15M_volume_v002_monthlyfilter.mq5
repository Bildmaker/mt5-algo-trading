//+------------------------------------------------------------------+
//| TT_ORB_2026_15M_volume_v002_monthlyfilter.mq5                   |
...
input group "Long Month Filter"
input bool   InpLongTradeJanuary           = true;
input bool   InpLongTradeFebruary          = true;
input bool   InpLongTradeMarch             = true;
input bool   InpLongTradeApril             = true;
input bool   InpLongTradeMay               = true;
input bool   InpLongTradeJune              = true;
input bool   InpLongTradeJuly              = true;
input bool   InpLongTradeAugust            = true;
input bool   InpLongTradeSeptember         = true;
input bool   InpLongTradeOctober           = true;
input bool   InpLongTradeNovember          = true;
input bool   InpLongTradeDecember          = true;

input group "Short Month Filter"
input bool   InpShortTradeJanuary          = true;
input bool   InpShortTradeFebruary         = true;
input bool   InpShortTradeMarch            = true;
input bool   InpShortTradeApril            = true;
input bool   InpShortTradeMay              = true;
input bool   InpShortTradeJune             = true;
input bool   InpShortTradeJuly             = true;
input bool   InpShortTradeAugust           = true;
input bool   InpShortTradeSeptember        = true;
input bool   InpShortTradeOctober          = true;
input bool   InpShortTradeNovember         = true;
input bool   InpShortTradeDecember         = true;
...
int GetNyMonth(const datetime serverTime)
{
   MqlDateTime nyTime;
   TimeToStruct(ServerToNewYorkTime(serverTime), nyTime);
   return nyTime.mon;
...
bool IsLongMonthEnabled(const int month)
{
   switch(month)
   {
      case 1:  return InpLongTradeJanuary;
      case 2:  return InpLongTradeFebruary;
      case 3:  return InpLongTradeMarch;
      case 4:  return InpLongTradeApril;
      case 5:  return InpLongTradeMay;
      case 6:  return InpLongTradeJune;
      case 7:  return InpLongTradeJuly;
      case 8:  return InpLongTradeAugust;
      case 9:  return InpLongTradeSeptember;
      case 10: return InpLongTradeOctober;
      case 11: return InpLongTradeNovember;
      case 12: return InpLongTradeDecember;
   }

   return false;
}

bool IsShortMonthEnabled(const int month)
{
   switch(month)
   {
      case 1:  return InpShortTradeJanuary;
      case 2:  return InpShortTradeFebruary;
      case 3:  return InpShortTradeMarch;
      case 4:  return InpShortTradeApril;
      case 5:  return InpShortTradeMay;
      case 6:  return InpShortTradeJune;
      case 7:  return InpShortTradeJuly;
      case 8:  return InpShortTradeAugust;
      case 9:  return InpShortTradeSeptember;
      case 10: return InpShortTradeOctober;
      case 11: return InpShortTradeNovember;
      case 12: return InpShortTradeDecember;
   }
